...
ggplot(data = fulldata, aes(x = declen/total.length)) +
    geom_histogram(aes(fill = scenario), alpha = 0.5, binwidth=0.005, position = "identity") +
    scale_fill_manual(values = c(bvdc.col(10)[5], bcdv.col(10)[5])) +
    #scale_colour_manual(values = c(bvdc.col(10)[10], bcdv.col(10)[10])) +
    #geom_vline(xintercept = 0 , linetype = "dashed") +
    facet_grid(time ~ .) +
    xlab("Relative Decline Length") +
    ylab("Frequency") +
    theme_bw() +
    theme(legend.position = "bottom")

ggplot(data = fulldata, aes(x = declen/(total.length - declen))) +
    geom_histogram(aes(fill = scenario), alpha = 0.5, binwidth=0.01, position = "identity") +
    scale_fill_manual(values = c(bvdc.col(10)[5], bcdv.col(10)[5])) +
    #scale_colour_manual(values = c(bvdc.col(10)[10], bcdv.col(10)[10])) +
    #geom_vline(xintercept = 0 , linetype = "dashed") +
    facet_grid(time ~ .) +
    xlab("Decline/Rise Length Ratio") +
    ylab("Frequency") +
    scale_x_log10() +
    theme_bw() +
    theme(legend.position = "bottom")

ggplot(data = fulldata, aes(x = lambda.init)) +
    geom_histogram(aes(fill = scenario), alpha = 0.5, binwidth=0.1, position = "identity") +
    scale_fill_manual(values = c(bvdc.col(10)[5], bcdv.col(10)[5])) +
    #scale_colour_manual(values = c(bvdc.col(10)[10], bcdv.col(10)[10])) +
    #geom_vline(xintercept = 0 , linetype = "dashed") +
    #facet_grid(time ~ .) +
...
ggplot(data = fulldata, aes(x = lambda.final)) +
    geom_histogram(aes(fill = scenario), alpha = 0.5, binwidth=0.1, position = "identity") +
    scale_fill_manual(values = c(bvdc.col(10)[5], bcdv.col(10)[5])) +
    #scale_colour_manual(values = c(bvdc.col(10)[10], bcdv.col(10)[10])) +
    #geom_vline(xintercept = 0 , linetype = "dashed") +
...
ggplot(data = fulldata, aes(x = mu.init)) +
    geom_histogram(aes(fill = scenario), alpha = 0.5, binwidth=0.1, position = "identity") +
    scale_fill_manual(values = c(bvdc.col(10)[5], bcdv.col(10)[5])) +
    #scale_colour_manual(values = c(bvdc.col(10)[10], bcdv.col(10)[10])) +
    #geom_vline(xintercept = 0 , linetype = "dashed") +
...
ggplot(data = fulldata, aes(x = mu.final)) +
    geom_histogram(aes(fill = scenario), alpha = 0.5, binwidth=0.1, position = "identity") +
    scale_fill_manual(values = c(bvdc.col(10)[5], bcdv.col(10)[5])) +
    #scale_colour_manual(values = c(bvdc.col(10)[10], bcdv.col(10)[10])) +
    #geom_vline(xintercept = 0 , linetype = "dashed") +
...
ggplot(data = fulldata, aes(x = lambda.init - mu.init)) +
    geom_histogram(aes(fill = scenario), alpha = 0.5, binwidth=0.1, position = "identity") +
    scale_fill_manual(values = c(bvdc.col(10)[5], bcdv.col(10)[5])) +
    #scale_colour_manual(values = c(bvdc.col(10)[10], bcdv.col(10)[10])) +
    #geom_vline(xintercept = 0 , linetype = "dashed") +
...
ggplot(data = fulldata, aes(x = lambda.final - mu.final)) +
    geom_histogram(aes(fill = scenario), alpha = 0.5, binwidth=0.025, position = "identity") +
    scale_fill_manual(values = c(bvdc.col(10)[5], bcdv.col(10)[5])) +
    #scale_colour_manual(values = c(bvdc.col(10)[10], bcdv.col(10)[10])) +
    #geom_vline(xintercept = 0 , linetype = "dashed") +
    facet_grid(time ~ .) +
...
ggplot(data = fulldata, aes(x = mu.init/lambda.init)) +
    geom_histogram(aes(fill = scenario), alpha = 0.5, binwidth=0.05, position = "identity") +
    scale_fill_manual(values = c(bvdc.col(10)[5], bcdv.col(10)[5])) +
    #scale_colour_manual(values = c(bvdc.col(10)[10], bcdv.col(10)[10])) +
    #geom_vline(xintercept = 0 , linetype = "dashed") +
...
ggplot(data = subset(fulldata, lambda.final >= quantile(fulldata$lambda.final,0.05)), aes(x = mu.final/lambda.final)) +
    geom_histogram(aes(fill = scenario), alpha = 0.5, binwidth=0.05, position = "identity") +
    scale_fill_manual(values = c(bvdc.col(10)[5], bcdv.col(10)[5])) +
    #scale_colour_manual(values = c(bvdc.col(10)[10], bcdv.col(10)[10])) +
    #geom_vline(xintercept = 0 , linetype = "dashed") +
